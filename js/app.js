...
export default class Sketch {
  constructor(options) {
    ...
    this.camera.position.set(0, 0, 0.8); // SET BACK TO 0.8
  ...
  addObjects() {
    ...
    this.plane.scale.set(4.5, 4.5, 4.5);
  ...
  class Shader {
    ...
    createElement() {
      ...
      this.container.style.cssText = `
        ...
        cursor: grab;
        backdrop-filter: url(#${this.id}_filter) blur(0.5px) contrast(0.99) brightness(1.1) saturate(1.2);
        z-index: 9999;
        pointer-events: auto;
      `;
